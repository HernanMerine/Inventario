    ...
    <form action="./php/producto_actualizar.php" method="POST" class="FormularioAjax" autocomplete="off">
        ...
        <div class="columns">
            <div class="column">
                <div class="control">
                    <label>Costo</label>
                    <input class="input" type="text" name="producto_costo" pattern="[0-9.]{1,25}" maxlength="25" required value="<?php echo $datos['producto_costo']; ?>">
                </div>
            </div>
            <div class="column">
                <div class="control">
                    <label>Porcentaje</label>
                    <input class="input" type="text" name="producto_porcentaje" pattern="[0-9]{1,25}" maxlength="25" required value="<?php echo $datos['porcentaje']; ?>">
                </div>
            </div>
            <div class="column">
                <div class="control">
